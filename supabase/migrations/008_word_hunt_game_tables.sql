create table if not exists public.word_hunt_exercises (
...
create table if not exists public.word_hunt_scores (
  id uuid primary key default gen_random_uuid(),
  user_id uuid not null,
  exercise_id uuid not null references public.word_hunt_exercises(id) on delete cascade,
