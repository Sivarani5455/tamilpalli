                ...
                <div className="flex items-center gap-5 px-5 py-4">
                  <div className="min-w-0 flex-1">
                    <div className="mb-2 flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-black uppercase tracking-wide text-[#8a6a9c]">{meta.level}</span>
                    </div>

                    <h2 className="truncate text-[15px] font-black leading-tight text-[#180d2b]">{exercise.title}</h2>
                    <p className="mt-0.5 text-xs font-semibold text-[#8a6a9c]">{exercise.slug}</p>
