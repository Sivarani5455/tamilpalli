...
import type { Locale, NimishamExercise } from "@/types";
...
function shuffleWords(words: NimishamExercise["words"], seed: string) {
  return [...words]
...
export function NimishamGame({
  exercise,
  locale,
}: {
  exercise: NimishamExercise;
  locale: Locale;
}) {
  ...
  function handleWordClick(word: NimishamExercise["words"][number]) {
