...
export function Footer() {
  return (
    <footer className="mt-14 border-t border-slate-200/80 bg-white/90 px-4 py-8 backdrop-blur sm:px-6">
      <div className="mx-auto grid max-w-[120rem] gap-8 lg:grid-cols-[1.05fr_0.95fr] xl:px-2">
        <div>
          <BrandMark />
          <h2 className="mt-5 max-w-2xl font-display text-3xl leading-tight text-[var(--brand-ink)]">
