...
import { getAdminNimishamExercises } from "@/lib/content-admin";
...
export default async function AdminNimishamPage({
  params,
}: {
  ...
  return (
    <div className="mx-auto max-w-5xl px-2 py-6 sm:px-4">
      <div className="flex items-center justify-between gap-4">
        ...
        <Link
          href={`/${locale}/admin/nimisham/new`}
          ...
          >
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-3">
                <Link
                  href={`/${locale}/admin/nimisham/${exercise.id}/edit`}
